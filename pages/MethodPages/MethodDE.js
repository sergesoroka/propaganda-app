...
export default function MethodDe() {
  return (
    <div>
      <Head>
      ...
      <div className={styles.container + " " + styles.aboutPageWrap}>
        ...
        <table className="c26">
          <tbody>
            <tr className="c5">
              <td style={{display: 'block'}} className="c18" colSpan="1" rowSpan="1">
                <p className="c3">
                  <span className="c11">№</span>
                </p>
              </td>
              <td style={{display: 'block'}} className="c9" colSpan="1" rowSpan="1">
                <p className="c3">
                  <span className="c11">Source</span>
                </p>
              </td>
              <td style={{display: 'block'}} className="c2" colSpan="1" rowSpan="1">
                <p className="c3">
                  <span className="c11">Description</span>
                </p>
              </td>
              <td style={{display: 'block'}} className="c1" colSpan="1" rowSpan="1">
                <p className="c3">
              ...
              <td style={{display: 'block'}} className="c2" colSpan="1" rowSpan="1">
                <p className="c3">
                  <span className="c12">
                    ...
                    specially authorized central executive body in the field of
                    statistics, whose activities are directed and coordinated by
                    the Cabinet of Ministers of Ukraine and which ensures the
                    formation and implementation of state policy in the field of
                    statistics.
                  </span>
                </p>
              </td>
              ...
              <td style={{display: 'block'}} className="c2" colSpan="1" rowSpan="1">
                <p className="c3">
                  <span className="c12">
                    ...
                    of Ukraine. Its main priorities are counterintelligence,
                    protection of national statehood, counterterrorism,
                    protection of informational security, protection of state
                    secrets.
                  </span>
                </p>
                <p className="c3 c27">
              ...
              <td style={{display: 'block'}} className="c2" colSpan="1" rowSpan="1">
                <p className="c3 c6">
                  <span className="c12">
                    ...
                    coordinating body in matters pertaining to national security
                    and defense under the President of Ukraine.
                  </span>
                </p>
              </td>
              <td style={{display: 'block'}} className="c1" colSpan="1" rowSpan="1">
              ...
              <td style={{display: 'block'}} className="c2" colSpan="1" rowSpan="1">
                <p className="c3">
                  <span className="c12">
                    ...
                    of the National Security and Defense Council of Ukraine. The
                    Center provides measures to counter current and projected
                    threats to national security and national interests of
                    Ukraine in the information sphere.
                  </span>
                </p>
              </td>
              <td style={{display: 'block'}} className="c1" colSpan="1" rowSpan="1">
              ...
              <td style={{display: 'block'}} className="c2" colSpan="1" rowSpan="1">
                <p className="c3">
                  <span className="c12">
                    ...
                    Ukraine. The body consist of Prime Minister of Ukraine, vice
                    prime ministers and other ministers from different
                    institutions. The prime minister presides over the cabinet.{" "}
                  </span>
                </p>
              </td>
              <td style={{display: 'block'}} className="c1" colSpan="1" rowSpan="1">
              ...
              <td style={{display: 'block'}} className="c2" colSpan="1" rowSpan="1">
                <p className="c3">
                  <span className="c12">
                    ...
                    the Cabinet of Ministers of Ukraine through the Minister of
                    Finance of Ukraine.
                  </span>
                </p>
              </td>
              ...
              <td style={{display: 'block'}} className="c2" colSpan="1" rowSpan="1">
                <p className="c3">
                  <span className="c12">
                    ...
                    body in the field of taxes in Ukraine. The activities of the
                    service are directed and coordinated by the Cabinet of
                    Ministers of Ukraine through the Minister of Finance.
                  </span>
                </p>
                <p className="c3">
                  <span className="c12">
                    The service implements the national tax policy and national
                    policy in the field of combating offenses during the
              ...
              <td style={{display: 'block'}} className="c2" colSpan="1" rowSpan="1">
                <p className="c3">
                  <span className="c12">
                    ...
                    combating offenses during the application of the legislation
                    on national customs affairs. The activities of the service
                    are directed and coordinated by the Cabinet of Ministers of
                    Ukraine through the Minister of Finance.
                  </span>
                </p>
              </td>
              <td style={{display: 'block'}} className="c1" colSpan="1" rowSpan="1">
              ...
              <td style={{display: 'block'}} className="c2" colSpan="1" rowSpan="1">
                <p className="c3 c6">
                  <span className="c29">
                    ...
                    agence charged with the tasks of ensuring inviolability of
                    state borders and protection of sovereign rights of Ukraine
                    within its exclusive (maritime) economic zone.
                  </span>
                </p>
              </td>
              <td style={{display: 'block'}} className="c1" colSpan="1" rowSpan="1">
              ...
              <td style={{display: 'block'}} className="c2" colSpan="1" rowSpan="1">
                <p className="c3">
                  <span className="c12">
                    ...
                    country&apos;s monetary circulation, including strengthening
                    of the national currency unit. Its mission is to ensure
                    price and financial stability, with the goal of contributing
                    to Ukraine’s sustainable economic development.
                  </span>
                </p>
              </td>
              <td style={{display: 'block'}} className="c1" colSpan="1" rowSpan="1">
              ...
              <td style={{display: 'block'}} className="c2" colSpan="1" rowSpan="1">
                <p className="c3">
                  <span className="c12">
                    ...
                    government policy: budgetary policy, tax and customs policy,
                    debt policy. international financial cooperation. The
                    mission of the Ministry is to provide financial basis for
                    the proper delivery of public functions supported by a
              ...
              <td style={{display: 'block'}} className="c2" colSpan="1" rowSpan="1">
                <p className="c3 c6">
                  <span className="c12">
                    ...
                    body in the system of central executive bodies to ensure the
                    implementation of state policy in the field of defense. It
                    participates in the implementation of state policy on
                    defense and military construction, coordination of
                    activities of state bodies and local governments to prepare
              ...
              <td style={{display: 'block'}} className="c2" colSpan="1" rowSpan="1">
                <p className="c3">
                  <span className="c31">
                    ...
                    the defence, development of military capability, military
                    and military-technical as well as cybersecurity areas.
                  </span>
                </p>
              </td>
              <td style={{display: 'block'}} className="c1" colSpan="1" rowSpan="1">
              ...
              <td style={{display: 'block'}} className="c2" colSpan="1" rowSpan="1">
                <p className="c3">
                  <span className="c12">
                    ...
                    Territories is government ministry in Ukraine, which solves
                    the tasks of prompt response to problems and threats
                    associated with the conduct of an anti-terrorist operation
                    in certain areas of the Donetsk and Luhansk regions, as well
                    as with the temporary occupation of the territory of
                    Ukraine.{" "}
                  </span>
                </p>
              </td>
              ...
              <td style={{display: 'block'}} className="c2" colSpan="1" rowSpan="1">
                <p className="c3">
                  <span className="c12">
                    ...
                    Decentralization means delegating considerable authority and
                    budgets from the state bodies to local authorities
                  </span>
                </p>
              </td>
              <td style={{display: 'block'}} className="c1" colSpan="1" rowSpan="1">
              ...
              <td style={{display: 'block'}} className="c2" colSpan="1" rowSpan="1">
                <p className="c3">
                  <span className="c12">
                    ...
                    relations, family and children, immigration and trafficking,
              ...
              <td style={{display: 'block'}} className="c2" colSpan="1" rowSpan="1">
                <p className="c3">
                  <span className="c12">
                    ...
                    Ukraine (MinRegion) carries out state regulation in
              ...
              <td style={{display: 'block'}} className="c2" colSpan="1" rowSpan="1">
                <p className="c3">
                  <span className="c12">
                    ...
                    implementation of the state policy in the electric power,
                    nuclear-industrial, coal-industrial, peat-mining, oil and
                    gas and oil-and-gas processing complexes, and also provides
                    the formation of the state policy in the sphere of
                    supervision (control) in the power and heat power
                    industries.
                  </span>
                </p>
              </td>
              ...
              <td style={{display: 'block'}} className="c2" colSpan="1" rowSpan="1">
                <p className="c3">
                  <span className="c12">
                    ...
                    body in the system of central government. It is based on
                    former Ministries of Healthcare.The Ministry of Health of
                    Ukraine organizational structure is composed of nine
                    directorates, four departments, three divisions, four
            ...
            <tr className="c5">
              ...
              <td style={{display: 'block'}} className="c2" colSpan="1" rowSpan="1">
                <p className="c3">
                  <span className="c12">
                    State Enterprise Center of Public Health of the Ministry of
                    Health of Ukraine it is a health care institution
                    responsible for maintaining and improving the health of the
                    population, social and hygienic monitoring of diseases,
                    epidemiological surveillance and biosafety, group and
                    population prevention of diseases, control of epidemics and
                    strategic management in the field of public health.{" "}
                  </span>
                </p>
              </td>
              <td style={{display: 'block'}} className="c1" colSpan="1" rowSpan="1">
              ...
              <td style={{display: 'block'}} className="c2" colSpan="1" rowSpan="1">
                <p className="c3">
                  <span className="c12">
                    ...
                    executive body that implements state policy in the field
                    &nbsp;of state financial guarantees for heathcare servising
                    of the population. &nbsp;Activities of the NHSU are directed
                    and coordinated by the &nbsp;Cabinet of Ministers of Ukraine
              ...
              <td style={{display: 'block'}} className="c2" colSpan="1" rowSpan="1">
                <p className="c3">
                  <span className="c12">
                    ...
                    Ukraine responsible for country&apos;s cultural development
              ...
              <td style={{display: 'block'}} className="c2" colSpan="1" rowSpan="1">
                <p className="c3">
                  <span className="c12">
                    ...
                    &nbsp;disinformation by joint efforts of the state and civil
                    society. The Centre is focused on communication that is
                    aiming to counter &nbsp;external threats, in particular
              ...
              <td style={{display: 'block'}} className="c2" colSpan="1" rowSpan="1">
                <p className="c3">
                  <span>
                    ...
                    state, protection of plant variety rights, animal husbandry,
                    plant cultivation, rural development and other areas of
              ...
              <td style={{display: 'block'}} className="c2" colSpan="1" rowSpan="1">
                <p className="c3 c6">
                  <span className="c30">
                    ...
                    rights and liberties of citizens, investigates unlawful acts
                    against the interest of society and state, fights crime,
                    provides civil order, ensures civil security and traffic
                    safety, and guarantees the security and protection of
              ...
              <td style={{display: 'block'}} className="c2" colSpan="1" rowSpan="1">
                <p className="c3 c6">
                  <span className="c12">
                    ...
                    in the system of central executive bodies in the formation
                    and implementation of state policy in the field of foreign
              ...
              <td style={{display: 'block'}} className="c2" colSpan="1" rowSpan="1">
                <p className="c3">
                  <span className="c12">
                    ...
                    executive agency with a special status responsible for
                    preventing, detecting, terminating, investigating, and
                    disclosing corruption and other criminal offences within its
                    jurisdiction, as well as preventing the commission of new
                    ones.{" "}
                  </span>
                </p>
              </td>
              ...
              <td style={{display: 'block'}} className="c2" colSpan="1" rowSpan="1">
                <p className="c3 c6">
                  <span className="c12">
                    ...
                    executive body with a special status. It is responsible for
                    the development of anti-corruption policy and prevention of
                    corruption.{" "}
                  </span>
                </p>
              </td>
              ...
              <td style={{display: 'block'}} className="c2" colSpan="1" rowSpan="1">
                <p className="c3">
                  <span className="c12">
                    ...
                    an independent structural unit of the General Prosecutor of
                    Ukraine, and is primarily responsible for supporting and
                    overseeing criminal investigations launched by the National
              ...
              <td style={{display: 'block'}} className="c2" colSpan="1" rowSpan="1">
                <p className="c3 c6">
                  <span className="c12">
                    ...
                    manages a solidarity system of compulsory state pension
                    provision, collects, accumulates and records insurance
                    premiums, allocates pensions and prepares documents for
                    their payment, provides timely and full financing and
                    payment pensions, burial assistance and other social
                    benefits.
                  </span>
                </p>
              </td>
              ...
              <td style={{display: 'block'}} className="c2" colSpan="1" rowSpan="1">
                <p className="c3 c6">
                  <span className="c12">
                    ...
                    development, production and exploration drilling, storage of
                    oil and gas, processing and distribution of oil products,
                    natural gas and liquefied gas to consumers.
                  </span>
                </p>
              </td>
              <td style={{display: 'block'}} className="c1" colSpan="1" rowSpan="1">
              ...
              <td style={{display: 'block'}} className="c2" colSpan="1" rowSpan="1">
                <p className="c3">
                  <span className="c12">
                    ...
                    the prosecution system. It organizes and coordinates the
                    activities of all bodies of the prosecution system.
                  </span>
                </p>
              </td>
              <td style={{display: 'block'}} className="c1" colSpan="1" rowSpan="1">
